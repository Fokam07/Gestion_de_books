...
export default function LibrarianNavbar() {
  ...
  return (
    <nav className="fixed w-full top-0 bg-white/95 backdrop-blur-md z-50 border-b border-blue-100 border-t-4 border-t-blue-500 shadow-md transition-all duration-300">
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <Link href="/" className="flex items-center shrink-0 transition-transform active:scale-98">
            <div className="relative flex items-center gap-3">
              ...
              <div className="flex items-center gap-1.5 bg-blue-50 text-blue-700 px-2.5 py-1 rounded-full text-xs font-bold font-sans">
                <FaBookReader /> Bibliothécaire
              </div>
            </div>
          </Link>
